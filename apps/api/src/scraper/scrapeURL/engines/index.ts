...
export function buildFallbackList(meta: Meta): {
	...
	console.log("buildFallbackList | _engines: ", _engines);
	...
	console.log("buildFallbackList | selectedEngines: ", selectedEngines);
	...
	console.log("buildFallbackList | currentEngines: ", currentEngines);

	for (const engine of currentEngines) {

		console.log("buildFallbackList | engine: ", engine);
		...
		console.log("buildFallbackList | supportedFlags: ", supportedFlags);
		...
		console.log("buildFallbackList | supportScore: ", supportedFlags);
		...
		console.log("buildFallbackList | unsupportedFeatures: ", unsupportedFeatures);

		meta.logger.debug(`Engine ${engine} support score`, {
			supportScore,
			prioritySum,
			priorityThreshold,
		...
		console.log("buildFallbackList | supportScore: ", supportScore);
		console.log("buildFallbackList | priorityThreshold: ", supportScore);
