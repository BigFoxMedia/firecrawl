...
export async function scrapeURLWithPlaywright(
	...
	console.log("scrapeURLWithPlaywright | meta: ", meta);
	
	const location = meta.options.location;
	const country = location?.country || "US";
	
	console.log("scrapeURLWithPlaywright | country: ", country);

	const proxy = "http://192.168.150.70:8888";
