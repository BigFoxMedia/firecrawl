...
app.post('/scrape', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pageError = pageStatusCode !== 200 ? (0, get_error_1.getError)(pageStatusCode) : undefined;
    if (!pageError) {
    ...
    yield page.close();
    res.json(Object.assign({ content: pageContent, pageStatusCode }, (pageError && { pageError })));
}));
app.listen(port, () => {
